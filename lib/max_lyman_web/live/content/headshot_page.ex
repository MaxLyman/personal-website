                ...
                <div class="flex-col">
                  ...
                  <div>
                    <p class="text-2xl font-medium font-sans pr-10">
                      ...
                      I'm always looking for new opportunities to learn and grow as a developer. My interests include data analysis, cyber security, DevOps, and cloud computing.
                    </p>
                  </div>
                </div>
            </div>
            ...
            <div class="h-144 pt-10 mx-auto">
              ...
              <div class="text-2xl font-medium font-sans pr-10 pt-5">
                <ul class="list-inside list-disc	">
                  <h3 class="font-bold text-3xl bebas-neue-regular">2021</h3>
                  <li> Data Visualization </li>
                  <li> Data Modeling </li>
                </ul>
                <ul class="list-inside list-disc	">
                    <h3 class="font-bold text-3xl bebas-neue-regular">2022</h3>
                    <li> Algorithms </li>
                ...
                <ul class="list-inside list-disc	">
                    <h3 class="font-bold text-3xl bebas-neue-regular">2023</h3>
